...
def write_learners():
    ...
    learner_james = Learner(first_name='James', last_name='Smith', dob=date(1982, 7, 16),
                            occupation='data_scientist', social_link='https://www.linkedin.com/james/')
    learner_james.save()
    
    learner_mary = Learner(first_name='Mary', last_name='Smith', dob=date(1991, 6, 12), 
                           occupation='dba', social_link='https://www.facebook.com/mary/')
    learner_mary.save()
    
    learner_robert = Learner(first_name='Robert', last_name='Lee', dob=date(1999, 1, 2), 
                             occupation='student', social_link='https://www.facebook.com/robert/')
    learner_robert.save()
    
    learner_david = Learner(first_name='David', last_name='Smith', dob=date(1983, 7, 16),
                            occupation='developer', social_link='https://www.linkedin.com/david/')
    learner_david.save()
    
    learner_john = Learner(first_name='John', last_name='Smith', dob=date(1986, 3, 16),
                           occupation='developer', social_link='https://www.linkedin.com/john/')
    learner_john.save()

    # <HINT> Add more learners objects#
    learner_lucy = Learner(first_name='Lucy', last_name='Brown', dob=date(1990, 5, 22), 
                           occupation='teacher', social_link='https://www.linkedin.com/lucy/')
    learner_lucy.save()
    
    learner_michael = Learner(first_name='Michael', last_name='Johnson', dob=date(1985, 9, 11), 
                              occupation='engineer', social_link='https://www.linkedin.com/michael/')
    learner_michael.save()
    
    learner_emma = Learner(first_name='Emma', last_name='Davis', dob=date(1992, 11, 30), 
                           occupation='designer', social_link='https://www.instagram.com/emma/')
    learner_emma.save()
    
    learner_oliver = Learner(first_name='Oliver', last_name='Miller', dob=date(1988, 2, 20), 
                             occupation='architect', social_link='https://www.linkedin.com/oliver/')
    learner_oliver.save()
    
    learner_sophia = Learner(first_name='Sophia', last_name='Martinez', dob=date(1995, 8, 14), 
                             occupation='scientist', social_link='https://www.linkedin.com/sophia/')
    learner_sophia.save()
